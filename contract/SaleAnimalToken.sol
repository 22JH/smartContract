...
contract SaleAnimalToken {
    ...
    constructor (address _minAnimalTokenAddress) {
        mintAnimalTokenAddress = MintAnimalToken(_minAnimalTokenAddress);
    }
    ...
    function setForSaleAnimalToken(uint256 _animalTokenId, uint256 _price) public {
        ...
        require(animalTokenOwner == msg.sender, "Caller is not owner");
